...
void ViewEdit::OnPaint(wxPaintEvent& event)
{
    ...
    //device context to draw with a scrolling offset
    DoPrepareDC(dc);
    ...
    //getting and setting virtual size for scrolling
...
/**
 * event handler when move mode is enabled
 * @param event the event that indicated the user has enabled move
 */
...
/**
 *event handler for when rotate mode is enabled
 * @param event the event that indicates the user has enabled rotate mode
 */
...
/**
 * updates the move mode
 * enables and disables it on consecutive clicks of the button
 * @param event the event that indicates move button has been clicked
 */
...
/**
 * updates the rotate mode
 * enables and disables it on consecutive clucks of the button
 * @param event the event that indicates rotate button has been clicked on
 */
