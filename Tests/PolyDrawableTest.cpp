...
{
    PolyDrawable poly1(L"RollyPolly");

    ASSERT_EQ(L"RollyPolly", poly1.GetName());
...
TEST(PolyDrawableTest, Colour)
{
    PolyDrawable poly1(L"RollyPolly");

    //tesing default value of colour
    ASSERT_EQ(*wxBLACK, poly1.GetColor());

    //Set colour
    poly1.SetColor(*wxRED);
    ASSERT_EQ(*wxRED, poly1.GetColor());
}